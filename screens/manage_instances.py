...
# Dummy instances list for demo
INSTANCES = [
    ['MyServer', 'Running', '14.08.2025', '3.1.51hf', 'Fabric', '1.20.1'],
    ['TestServer', 'Stopped', '10.07.2025', '1.0.2', 'Forge', '1.19.4'],
    ['OldServer'],
]
...
class ManageInstancesScreen(Screen):
    ...
    async def load_table(self):
        ...
        for instance in registry.instances:
            row = [
                instance.name or '',
                instance.status.title() if instance.status else '',
